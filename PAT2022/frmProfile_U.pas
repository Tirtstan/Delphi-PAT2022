...
begin
  ...
  if NOT(lowercase(sEmail) = lowercase(redEmail.Text)) then
  begin
  ...
  begin
    ...
    begin
      // Database Check
      if objFormatCalculation.AllowedEmailDatabase(sNewEmail) = true then
      begin
      ...
      begin
        ShowMessage('Email taken. Try again.');
        exit;
      end;
    end
    else
...
begin
  ...
  begin
    ...
    begin
      ...
      if objFormatCalculation.AllowedPhoneNoDatabase(sNewPhoneNumber) = true
      then
      begin
        ShowMessage('Settings saved! Click confirm changes to apply them!');
        bitConfirmChanges.Enabled := true;
      ...
      begin
        ShowMessage('Phone number taken. Try again.');
        exit;
      end;
    end
    else
