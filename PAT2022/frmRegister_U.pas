...
begin
  ...
  begin
    lblNameError.Font.Color := SecondaryBrighter;
  ...
  begin
    lblSurnameError.Font.Color := SecondaryBrighter;
  ...
  begin
    ...
    if objFormatCalculations.AllowedEmailDatabase(edtEmailR.Text) = true then
    begin
      lblEmailError.Font.Color := clLime;
  ...
  begin
    lblPasswordError.Font.Color := SecondaryBrighter;
  ...
  begin
    ...
    if objFormatCalculations.AllowedIDDatabase(edtIDR.Text) = true then
    begin
      lblIDError.Font.Color := clLime;
  ...
  begin
    ...
    if objFormatCalculations.AllowedPhoneNoDatabase(edtPhoneNumberR.Text) = true
    then
    begin
      lblPhoneNumberError.Font.Color := clLime;
  ...
  if bPfp = false then
  begin
    lblPfpError.Font.Color := SecondaryBrighter;
